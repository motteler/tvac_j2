...
% search grid
wgrid = -0.015 : 0.0002 : 0.02; 
waxis = wlaser + wgrid;

% run name for plots
pname = 'CO 15 Oct 2014 MN S1';
...
opt.user_res = 'hires';
opt.inst_res = 'hires2';
opt.sfile = '../inst_data/SAinv_umbc2_HR2_SW';
opt.afile = 'run8_41t_CO';  % tabulated absorptions
...
% export_fig('CO_wlaser_fit.pdf', '-m2', '-transparent')
...
% export_fig('CO_obs_and_calc.pdf', '-m2', '-transparent')
