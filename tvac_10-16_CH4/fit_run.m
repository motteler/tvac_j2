...
opt.user_res = 'hires';
opt.inst_res = 'hires2';
opt.sfile = '../inst_data/SAinv_umbc2_HR2_MW';
...
% test data files
test_dir = '/asl/data/cris/test/2014-10-16_CH4';
...
% export_fig('CH4_wlaser_fit.pdf', '-m2', '-transparent')
...
% export_fig('CH4_obs_and_calc.pdf', '-m2', '-transparent')
